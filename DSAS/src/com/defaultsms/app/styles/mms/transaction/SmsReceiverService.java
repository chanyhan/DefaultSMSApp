...
package com.defaultsms.app.styles.mms.transaction;
...
import com.defaultsms.app.styles.mms.MmsException;
            ...
            try {
                if (c.moveToFirst()) {
                    ...
                    try {
                        ...
                        mSending = true;
                    } catch (Exception e) {//MmsException
...
//                        uri, values, null, null);
    ...
    private int moveOutboxMessagesToQueuedBox() {
        ...
        int messageCount = getContentResolver().update(
                Outbox.CONTENT_URI,
...
//                }
        ...
        Cursor cursor = getContentResolver().query( Inbox.CONTENT_URI,
        ...
        if (cursor != null) {
            try {
                if (cursor.moveToFirst()) {
                    ...
                    getContentResolver().update(messageUri,
                                        values, null, null);
                    return messageUri;
                }
            } finally {
